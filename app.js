...
// ----------------------------------------------------
const savedSession = localStorage.getItem('ifa_user');
if (savedSession) {
...
// ----------------------------------------------------
// REAL-TIME USERS & ADMIN PANEL LOGIC
// ----------------------------------------------------
...
function renderAdminPanel() {
    ...
    // Update Red Notification Badge safely
...
db.collection("users").onSnapshot((snapshot) => {
    ...
    if (currentUser && currentUser.role === 'admin') {
        ...
        // Push notification logic for newly registered users
...
function handleLogin() {
    ...
    currentUser = user;
    localStorage.setItem('ifa_user', JSON.stringify(currentUser));
    loadDashboard();
}
...
function loadDashboard() {
    ...
    // CRITICAL FIX: Force redraw of dropdowns and admin panel upon successful login
    updateStaffDropdowns();
    if (isSuperAdmin) {
        renderAdminPanel();
    }
...
// ----------------------------------------------------
// SMART "INSTALL APP" BUTTON LOGIC
// ----------------------------------------------------
let deferredPrompt;
